...
As it becom more and more popular these years , many projects were writen in golang but many of them rely on frameworks. but i'm not going to use it in this project , you will see the convenience and high-performance using native go to create project is also a better choice.
